    ...
    <section className="relative w-full pt-[72px] overflow-hidden px-6 lg:px-16 bg-gradient-to-br from-[#eef6fb] via-[#e4eff7] to-[#d6e7f3]">
      ...
      <div className="relative container mx-auto py-16 lg:py-28 flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="flex-1 max-w-xl z-10">
          {/* Trust badge */}
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary-600/10 border border-primary-600/20 mb-6">
            <ShieldCheck size={14} className="text-primary-600" />
            <span className="text-xs font-semibold text-primary-700 tracking-wide">RTB Compliant &amp; Fully Regulated</span>
          </div>

          <h1 className="text-[2.8rem] lg:text-[3.6rem] leading-[1.08] font-bold text-dark-950 mb-6">
            Professional
            <br />
          ...
          <p className="text-[1rem] text-dark-500 leading-relaxed mb-8 max-w-md">
          ...
          <div className="flex items-center gap-3">
            <div className="flex -space-x-2">
              {["1580489944","1573496359142","1463453091185"].map((id) => (
        ...
        <div className="flex-1 relative min-h-[360px] lg:min-h-[480px] w-full">

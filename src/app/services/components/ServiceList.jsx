        ...
        {services.map((service, idx) => (
          ...
          >
            ...
            <div className={idx % 2 === 1 ? "lg:[direction:ltr]" : ""}>
              ...
              <p className="text-[0.95rem] text-dark-500 leading-relaxed mb-6">{service.desc}</p>
              <ul className="space-y-3">
                {service.features.map(({ icon: FeatIcon, text }) => (
                  <li key={text} className="flex items-center gap-3">
                    <div className="w-8 h-8 rounded-lg bg-gray-50 text-dark-500 flex items-center justify-center flex-shrink-0">
                      <FeatIcon size={16} />
                    </div>

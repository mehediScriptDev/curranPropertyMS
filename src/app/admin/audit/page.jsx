  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl border border-slate-100 shadow-sm p-12 flex flex-col items-center justify-center text-center gap-3">
        ...
        <h3 className="text-lg font-bold text-slate-700">Audit Log coming soon</h3>
        <p className="text-sm text-slate-400 max-w-sm">The audit log module is under construction.</p>
      </div>
    </div>
  );
}
